...
@section('content')
    <div class="container all_report">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-square btn-lg btn-primary"  href="{!! action('AttendanceController@attendanceFill', $course_id) !!}"><i class="fa fa-users"></i> <span>Attendance</span></a>
            </div>
            <div class="col-md-3">
...
{{--                <a class="btn btn-square btn-lg btn-info"  href="{!! action('MarksheetAdminController@index', $course_id) !!}"><i class="fa fa-graduation-cap"></i> Mark Sheet</a>--}}
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a style="background-color: #FFC107; color: #fff;" class="btn btn-square btn-lg"  href="{!! action('AdminController@trainee_by_course_id', $course_id) !!}"><i class="fa fa-info"></i> Information</a>
            </div>
        </div>
    </div>
@endsection
