            ...
            <form class="form-horizontal" method="post" id="announcementform">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="title" placeholder="Give a heading" name="heading" value="{!! $announcement->heading !!}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="content" class="col-lg-2 control-label"><font color="#009688" size="3">Content</font></label>
                        <div class="col-lg-10">
                            <textarea class="form-control" rows="5" id="content" placeholder="Write content" name="content">{!! $announcement->content !!}</textarea>
