...
class AdminTrainersController extends Controller
{
    ...
    public function adminShow($id)
    {
        ...
        //return $courses;
         ...
         return view('admin.AdminTrainer.show', compact('trainer', 'courses'));
    ...
    public function adminUpdate($id, TrainerFormRequest $request)
{
 ...
 $input=$request->all();
    ...
    $trainer->save();
    return redirect(action('AdminTrainersController@adminShow', $trainer->id))->with('status', 'The trainer status has been updated!');
